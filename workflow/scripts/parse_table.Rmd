...
all_cases_raw<-read_xlsx(in_file, guess_max = 2000, .name_repair = own_name_repair, sheet="S1")  # remove double occuring cases (for security, should already be removed)
